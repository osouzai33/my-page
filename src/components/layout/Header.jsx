  ...
  return (
    <header className="sticky p-0 top-0 bg-gray-100 z-50">
      <div className="flex w-[calc(100% - 10px)] border-b-2 border-black">
        <div className="px-6 py-12 basis-3/12 grow-0 border-r-2 border-black text-white font-extrabold  ">
          <h1 className="text-3xl text-gray-400"></h1>
        </div>
        <div className="px-6 py-12 basis-1/12 grow-0 border-r-2 border-black text-white font-extrabold  ">
          <h1 className="text-3xl text-gray-400"></h1>
        </div>
